...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Drugs Edit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Edit a Drug
                        </div> 
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="post">  
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="dru_name" placeholder="Please enter drug name" value="<?php echo set_value('dru_name', $drugs_list->dru_name); ?>">
                                            <p class="help-block"></p>
                                        </div>
                                        <div class="form-group ">
                                            <label>Drug Description</label>
                                            <textarea class="form-control"  name="dru_description"  ><?php echo set_value('dru_description', $drugs_list->dru_description); ?></textarea>
                                            <p class="help-block"></p>
                                        </div>
                                         <div class="form-group">

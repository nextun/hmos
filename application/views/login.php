...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="<?=base_url('dist/metisMenu.min.css');?>" rel="stylesheet">
...
<body>
                        ...
                        <form role="form" action="<?=site_url('/login');?>" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="usertype" id="usertypedoctor" value="doctor" checked>Doctor
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="usertype" id="usertypenurse" value="nurse">Nurse
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
    ...
    <script src="<?=base_url('dist/metisMenu.min.js');?>"></script>

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tokens List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                          ...
                          <?php
                            foreach ($tokens_list as $rows) {
                                ...
                                echo	"<tr>
                                        ...
                                        <td><a href='tokens/check/".$rows->tok_number."' class='btn btn-primary'>Edit</a>
                                            <a href='tokens/note/".$rows->tok_number."' class='btn btn-warning'>Note</a> </td>
                                        </tr>";

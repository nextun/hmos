                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="nurse_id" class="form-control" >
                                                ...
                                                <?php foreach($nurse_list as $nurse): ?>
                                                    <option value="<?=$nurse->id ;?>" <?php echo set_select('nurse_id', $nurse->id,  $nurseward_list->nurse_id==$nurse->id ? TRUE : FALSE); ?>><?=$nurse->nur_name ;?></option>
                                                <?php endforeach;?> 
                                            ...
                                            <label>Ward</label>
                                             <select  name="ward_id" class="form-control" >
                                                ...
                                                <?php foreach($ward_list as $wards): ?>
                                                    <option value="<?=$wards->id ;?>" <?php echo set_select('ward_id', $wards->id, $nurseward_list->ward_id==$wards->id ? TRUE : FALSE); ?>><?=$wards->war_name ;?></option>
                                                <?php endforeach;?> 

                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Drugs List
                        </div> 
                        <!-- /.panel-heading -->
                        ...
                        <tbody>
                          ...
                          if($stock_list != FALSE){
                            ...
                            foreach ($stock_list as $rows) {
                                echo	"<tr>
                                        <td>".$rows->id."</td>
                                        <td>".$rows->dru_name."</td> 
                                        <td>".$rows->quantity."</td>    
                                        <td>".$rows->min_level."</td>
                                        <td><a href='".base_url('stock/edit/'.$rows->id.'')."' class='btn btn-default'>Edit</a></td>
                                        </tr>";
                        
                            }
                          }else{
                            echo	"<tr>
                                        <td colspan='5'>Drugs not found!</td>
                                        </tr>";
                        ...
                        <div class="form-group">
                            <a href="<?=base_url('stock/add/'.$wardid.'');?>" class="btn btn-default">Add</a>
                        </div>
                        </div>
                        <!-- /.table-responsive -->

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Drugs New</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Add s Drug to Ward
                        </div> 
                        <!-- /.panel-heading -->
                            ...
                            <form role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="drug_id" class="form-control" >
                                                ...
                                                <?php foreach($drugs_list as $drug): ?>
                                                    <option value="<?=$drug->id ;?>" <?php echo set_select('drug_id', $drug->id, FALSE); ?>><?=$drug->dru_name ;?></option>
                                                <?php endforeach;?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="drup_type" class="form-control" >
                                                ...
                                                <?php foreach($drug_types as $key => $type): ?> 
                                                    <option value="<?=$type->id;?>" <?php echo set_select('drup_type', $type->id, FALSE); ?>><?=$type->type;?></option>
                                                <?php endforeach;?>  
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Quantity</label>
                                            <input class="form-control" type="text" name="quantity" placeholder="Please enter drug quantity" value="<?php echo set_value('quantity', 0 ); ?>">
                                            <p class="help-block"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Min level</label>
                                            <input class="form-control" type="text" name="min_level" placeholder="Please enter drug min level" value="<?php echo set_value('min_level', 0 ); ?>">
                                            <p class="help-block"></p>
                                        </div>
                                         <div class="form-group">

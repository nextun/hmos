                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Nurse List
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <tbody>
                          ...
                          <?php 
                            foreach ($nurse_list as $rows) {
                                echo	"<tr>
                                        <td>".$rows->id."</td>
                                        <td>".$rows->nur_name."</td>
                                        <td>".$rows->nur_mobile."</td>
                                        <td>".$rows->nur_status."</td>
                                        <td><a href='nurse/edit/".$rows->id."' class='btn btn-info'>Edit</a>  </td>
                                        </tr>";

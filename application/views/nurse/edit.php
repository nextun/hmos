...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nurse Edit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Edit a Nurse
                        </div> 
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nursename" value="<?=set_value('nursename', $nurse_list->nur_name);?>">
                                            <p class="help-block">Please enter name of the Nurse</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nurse's Mobile number</label>
                                            <input class="form-control" type="tel" name="nursemobile" value="<?=set_value('nursemobile', $nurse_list->nur_mobile);?>">
                                            <p class="help-block">Please enter Nurse's valid mobile number</p>
                                        </div> 
                                         <div class="form-group">

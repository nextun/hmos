                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Doctors List
                        </div> 
                        <!-- /.panel-heading -->
                          ...
                          <?php 
                            foreach ($doctorslist as $rows) {
                                echo	"<tr>
                                        <td>".$rows->id."</td>
                                        <td>".$rows->doc_name."</td>
                                        <td>".$rows->doc_mobile."</td>
                                        <td>".$rows->doc_main_hospital."</td>
                                        <td>".$rows->doc_status."</td>
                                        <td><a href='doctor/edit/".$rows->id."' class='btn btn-info'>Edit</a> <a class='btn btn-danger'>Delete</a> </td>
                                        </tr>";

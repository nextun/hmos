                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Patient List
                        </div> 
                        <!-- /.panel-heading -->
                          ...
                          <?php 
                            foreach ($patient_list as $rows) {
                                echo	"<tr>
                                        <td>".$rows->id."</td>
                                        <td>".$rows->pat_name."</td>
                                        <td>".$rows->pat_date_of_birth."</td> 
                                        <td>".$rows->pat_status."</td>
                                        <td><a href='patient/edit/".$rows->id."' class='btn btn-primary'>Edit</a>  </td>
                                        </tr>";

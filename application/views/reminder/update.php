                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Token Details
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          ...
                          <?php
                            ...
                            foreach ($next_drugs as  $drugs){ ?>
                              <div><?=$drugs['next_time'];?></div>
                              <blockquote>
                                    <p>Drug name : <?=$drugs['dru_name'];?></p>
                                    <p><?=$drugs['next'];?></p>
                                    <p><?=$drugs['timerate'];?> Per <?=$drugs['per_time'];?> <?=$drugs['quantity'];?> <?=$drugs['type'];?> </p>
                                    <p><?=$drugs['dru_name'];?></p>
                                    <p><?=$drugs['dru_name'];?></p>
                              </blockquote>
                          <?php  } ?>

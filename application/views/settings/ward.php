                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <?php } ?>
                            <?=validation_errors();?>
                            <form role="form" action="<?=base_url('ward/insert');?>" method="post">
                                        <div class="form-group">
                                            <label>Ward Name</label>
                                            <input class="form-control" type="text" name="wardname" placeholder="Please enter ward name" value="<?=set_value('wardname', $ward_by->war_name);?>">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Ward List
                        </div> 
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                        ...
                        <tbody>
                          ...
                          <?php 
                            foreach ($ward_list as $rows) {
                                echo	"<tr>
                                        <td>".$rows->id."</td>
                                        <td>".$rows->war_name."</td> 
                                        <td>".$rows->war_status."</td>
                                        <td><a href='ward/edit/".$rows->id."' class='btn btn-info'>Edit</a>  </td>
                                        </tr>";

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ward Edit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Edit a Ward
                        </div> 
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="war_name" value="<?=set_value('war_name', $ward_list->war_name);?>">
                                            <p class="help-block">Please enter ward name</p>
                                        </div>

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bed Edit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Edit a Bed
                        </div> 
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="bed_number" value="<?=set_value('bed_number', $bed_list->bed_number);?>">
                                            <p class="help-block">Please enter Bed number</p>
                                        </div>
                                         
                                        <div class="form-group">
                                             <select  name="bed_ward_id" class="form-control" >
                                                <option value="">Select</option>
                                                <?php foreach($ward_list as $wards): ?>
                                                    <option value="<?=$wards->id ;?>" <?php echo set_select('bed_ward_id', $wards->id, $bed_list->bed_ward_id==$wards->id ? TRUE : FALSE); ?>><?=$wards->war_name ;?></option>
                                                <?php endforeach;?> 
